...
COME FRONTEND E CONTROLLER COMUNICANO CON LE ACTION --> struts 
In \textit{TicketAction} troviamo delle funzioni, dette anche \textit{Action}, dove ognuna è riconosciuta in modo univoco da una nomenclatura utilizzata per far comunicare il front-end con il controller. \\ 
Il collegamento tra front-end e le \textit{Action} 
